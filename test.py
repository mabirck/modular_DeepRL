...
def evaluate(actor_critic, ob_rms, env_name, act_func, seed, extra):
    tmp_drop = actor_critic.drop
    actor_critic.drop = 0
    ...
    process_file(env_name, act_func, sd[0], seed, extra)
    actor_critic.drop =tmp_drop
